...
public class Board extends Subject {
    ...
    public String getStatusMessage() {
        ...
        //      of the current move!
        return "Player = " + getCurrentPlayer().getName()+ "number of steps "+ getCount();
    }
    ...
    /*
    her we create counter  to count number of steps
     */
     private int count;
    ...
    public void setCount(int count) {
        /*
        her is counter sent notification  if there is not equl som move
        så if some move no need to send notification
         */
        if(this.count!=count) {
            this.count = count;
            notifyChange();
